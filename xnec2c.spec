...
# autospec version: v8
# autospec commit: 658bd0de108a
#
Name     : xnec2c
Version  : 4.4.14
Release  : 6
URL      : https://www.xnec2c.org/releases/xnec2c-v4.4.14.tar.gz
Source0  : https://www.xnec2c.org/releases/xnec2c-v4.4.14.tar.gz
...
%prep
%setup -q -n xnec2c-v4.4.14
cd %{_builddir}/xnec2c-v4.4.14
pushd ..
cp -a xnec2c-v4.4.14 buildavx2
popd
pushd ..
cp -a xnec2c-v4.4.14 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712877289
