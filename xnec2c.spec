...
Source0  : https://www.xnec2c.org/releases/xnec2c-v4.4.13.tar.gz
...
%prep
%setup -q -n xnec2c-v4.4.13
cd %{_builddir}/xnec2c-v4.4.13
pushd ..
cp -a xnec2c-v4.4.13 buildavx2
popd
pushd ..
cp -a xnec2c-v4.4.13 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712457519
